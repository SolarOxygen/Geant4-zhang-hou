...
#ifndef G4STARTElectricFieldSetup_h
#define G4STARTElectricFieldSetup_h 1
...
{
public:
  G4STARTElectricFieldSetup(G4ThreeVector);  //  The value of the field
  G4STARTElectricFieldSetup();               //  A zero field - true value set later

  virtual ~G4STARTElectricFieldSetup();
...
private:
  ...
  G4STARTFieldMessenger*      fFieldMessenger;
