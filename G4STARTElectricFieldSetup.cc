...
#include "G4STARTFieldMessenger.hh"
...
G4STARTElectricFieldSetup::G4STARTElectricFieldSetup()
   ...
   fFieldMessenger(nullptr)   
{
  fEMfield = new G4UniformElectricField(
                   G4ThreeVector(0.0,100000.0*volt/m,0.0));
  fEquation = new G4EqMagElectricField(fEMfield);

  fFieldManager = GetGlobalFieldManager();

  UpdateIntegrator();
  fFieldMessenger = new G4STARTFieldMessenger(this);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

G4STARTElectricFieldSetup::G4STARTElectricFieldSetup(G4ThreeVector fieldVector)
  : fMinStep(0.010*mm),  // minimal step of 10 microns
    fFieldManager(0),
    fChordFinder(0),
    fEquation(0),
...
void G4STARTElectricFieldSetup::UpdateIntegrator()
{
...
void G4STARTElectricFieldSetup::CreateStepper()
{
...
void G4STARTElectricFieldSetup::SetFieldZValue(G4double fieldValue)
{
...
void G4STARTElectricFieldSetup::SetFieldValue(G4ThreeVector fieldVector)
{
...
G4FieldManager*  G4STARTElectricFieldSetup::GetGlobalFieldManager()
{
//  Utility method
