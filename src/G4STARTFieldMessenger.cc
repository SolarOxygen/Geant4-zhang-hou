...
G4STARTFieldMessenger::G4STARTFieldMessenger(G4STARTElectricFieldSetup* fieldSetup)
 : G4UImessenger(),
...
G4STARTFieldMessenger::~G4STARTFieldMessenger()
{
  delete fStepperCmd;
  delete fElFieldZCmd;
  delete fElFieldCmd;
...
void G4STARTFieldMessenger::SetNewValue(G4UIcommand* command, G4String newValue)
{
